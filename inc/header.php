					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								...
								<img src="/secuv2/dist/img/avatar<?= $_SESSION["auth"]->avatar ?>.png" class="user-image" alt="User Image">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header">
									<img src="/secuv2/dist/img/avatar<?= $_SESSION["auth"]->avatar ?>.png" class="img-circle" alt="User Image">
